...
public:
    ...
    Character(const int t_cell_x, const int t_cell_y, const int LocalScreenx, const int LocalScreeny, const bool belong, QWidget* parent = nullptr);
protected:
    QPixmap m_icon; // 人物图标
    QString m_name; // 人物名称
...
public:
    int m_hp, m_fullhp, m_move,m_fullmove,m_attrack, m_attrackable; // 人物各项属性
