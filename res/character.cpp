...
Character::Character(const int t_cellx, const int t_celly, const int LocalScreenx, const int LocalScreeny, const bool belong, QWidget* parent) :
    ...
    m_localCelly(t_celly - LocalScreeny / CELL_SIZE)
{
    ...
    connect(m_mover, &MoveAnimation::widgetDown, this, [=]() {m_celly++; m_localCelly++; });
    connect(m_mover, &MoveAnimation::widgetUp, this, [=]() {m_celly--; m_localCelly--; });
    connect(m_mover, &MoveAnimation::widgetRight, this, [=]() {m_cellx++; m_localCellx++; });
    connect(m_mover, &MoveAnimation::widgetLeft, this, [=]() {m_cellx--; m_localCellx--; });
    ...
    connect(this, &Character::infoChanged, [=]() {
        ...
        m_propertyDlg->updateData(m_hp, m_fullhp, m_move, m_fullmove, m_localCellx, m_localCelly);
        m_selectionDlg->updateData(m_localCellx, m_localCelly);
